...
// Responsive: centered modal on all screen sizes (mobile, tablet, desktop)
// ============================================================================
    ...
    <AnimatePresence>
      {show && (
        <>
          ...
          {/* Centered modal wrapper — uses flexbox to center on ALL screen sizes */}
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-3 sm:p-4 md:p-5 pointer-events-none">
            {/* Inner panel — relative positioning, scrollable if content overflows */}
            <motion.div
              ...
              className="pointer-events-auto w-[95vw] max-w-sm rounded-xl border border-white/10 bg-white/5 shadow-2xl backdrop-blur-2xl max-h-[90vh] overflow-y-auto p-3 sm:p-4 md:p-5"
            >
              {/* Close button */}
              <button
                onClick={onClose}
